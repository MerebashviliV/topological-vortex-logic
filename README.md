...
#### v1.0.6 — 22 July 2026 (pending deposit)

Corrects the v1.0.5 deposit, which was published with the v1.0.4 files. The changes
below were intended for v1.0.5 and first ship here.
